...
(function () {
  ...
  const ZH_DICT = {
    ...
    'Talking to other': '多人交谈场景',
    'Background speech': '背景人声',
    'Addressed speech': '指向性交互',
    'Backchannel': '语气附和',
  ...
  const ZH = {
    ...
    '#demos h2': '四段对话<br>一次连贯交互',
    '#demos .section-heading > p': '演示录音展示了多方全双工交互、<br class="desktop-break">角色扮演与情感表达、工具调用与执行，以及流畅的多语言多轮切换。',
